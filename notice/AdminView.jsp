...
<main>
	...
	function orNotice() {
    	...
    	if (userId === "202230337") {
        	window.location.href = "../notice/AdminList.jsp";
    	} else {
        	window.location.href = "../notice/UserNoticeView.jsp";
    	}
	}
	</script>
    ...
    try
    {
        ...
        <table border="1">
            ...
            {%>
            	...
            	<tr>
            	    <td colspan="2">
            	        <button type=button onclick="location.href='AdminList.jsp'">목록</button>
            	    </td>
            	</tr>
            	<%            	
            }%>
