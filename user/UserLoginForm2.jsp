...
margin:0 auto;">
    <form action="http://localhost:8080/Bustago/notice/AdminList.jsp" name="LoginForm" method="post">
        <input type="text" id="userId" name="userId" placeholder="학번을 입력해주세요." class="form-control form-control-lg">
        <input type="password" id="userPw" name="userPw" placeholder="비밀번호를 입력해주세요" class="form-control form-control-lg">
...
<script type="text/javascript">
    function checkform(){
        ...
        else if(isNaN(userId.substr(0, 1))){
